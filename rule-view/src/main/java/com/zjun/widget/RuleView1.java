 ...
 * Date 2018/7/29
 */
public class RuleView1 extends View {
    ...
    public RuleView1(Context context) {
        this(context, null);
    }

    public RuleView1(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RuleView1(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
